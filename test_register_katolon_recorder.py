...
class AppDynamicsJob(unittest.TestCase):
    ...
    def test_app_dynamics_job(self):
        ...
        driver.find_element_by_id("id_registration-email").send_keys(f"test1+{str(int(round(time.time() * 1000)))}@gmail.com")
        driver.find_element_by_id("id_registration-password1").click()
        driver.find_element_by_id("id_registration-password1").click()
        driver.find_element_by_id("id_registration-password1").clear()
        driver.find_element_by_id("id_registration-password1").send_keys("R0ZPg2A6c")
        driver.find_element_by_id("id_registration-password2").click()
        driver.find_element_by_id("id_registration-password2").clear()
        driver.find_element_by_id("id_registration-password2").send_keys("R0ZPg2A6c")
        driver.find_element_by_id("register_form").click()
